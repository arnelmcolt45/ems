...
namespace Ems.Test.Base
{
    ...
    /// Provides methods to easily work with <see cref="EmsDbContext"/>.
    /// </summary>
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        protected TResult UsingDbContext<TResult>(Func<EmsDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<EmsDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<EmsDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<EmsDbContext, Task<TResult>> func)
        {
            TResult result;
