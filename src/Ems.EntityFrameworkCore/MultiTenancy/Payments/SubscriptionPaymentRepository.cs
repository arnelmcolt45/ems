...
using Ems.EntityFrameworkCore.Repositories;

namespace Ems.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : EmsRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<EmsDbContext> dbContextProvider)
