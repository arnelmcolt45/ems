...
namespace Ems.Migrations
{
    ...
    [Migration("20201216221838_Added_MaintenanceSteps")]
    partial class Added_MaintenanceSteps
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ems.Assets.AssetNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Assets.AssetPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("AssetPartStatusId");

                    b.Property<int?>("AssetPartTypeId");
                    ...
                    b.HasIndex("AssetPartStatusId");

                    b.HasIndex("AssetPartTypeId");
            ...
            modelBuilder.Entity("Ems.Assets.AssetPartStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("AssetPartStatuses");
                });

            modelBuilder.Entity("Ems.Assets.AssetPartType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Assets.InventoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Assets.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Billing.CustomerInvoiceDetail", b =>
                {
                    ...
                    b.Property<int?>("WorkOrderActionId");
            ...
            modelBuilder.Entity("Ems.Billing.XeroConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("XeroConfigurations");
                });

            modelBuilder.Entity("Ems.Billing.XeroInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<bool>("XeroInvoiceCreated");

                    b.Property<string>("XeroReference");
            ...
            modelBuilder.Entity("Ems.Customers.Customer", b =>
                {
                    ...
                    b.Property<int?>("PaymentTermNumber");
                    ...
                    b.Property<string>("XeroAccountsPayableTaxType");

                    b.Property<string>("XeroAccountsReceivableTaxType");

                    b.Property<string>("XeroAddresses");

                    b.Property<string>("XeroContactId");

                    b.Property<string>("XeroContactPersons");

                    b.Property<string>("XeroDefaultCurrency");

                    b.Property<string>("XeroPaymentTerms");

                    b.Property<string>("XeroPhones");
            ...
            modelBuilder.Entity("Ems.Finance.AgedReceivablesPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<decimal>("Over120");

                    b.Property<decimal>("Over30");

                    b.Property<decimal>("Over60");
                    ...
                    b.ToTable("AgedReceivablesPeriods");
                });
            ...
            modelBuilder.Entity("Ems.Security.XeroToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Storage.AzureStorageConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("BlobStorageEndpoint")
                        .IsRequired();
                    ...
                    b.ToTable("AzureStorageConfigurations");
                });
            ...
            modelBuilder.Entity("Ems.Support.EstimateDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Support.MaintenancePlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Support.MaintenanceStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Support.WorkOrderAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Ems.Assets.AssetPart", b =>
                {
                    ...
                    b.HasOne("Ems.Assets.AssetPartStatus", "AssetPartStatusFk")
                        .WithMany()
                        .HasForeignKey("AssetPartStatusId");

                    b.HasOne("Ems.Assets.AssetPartType", "AssetPartTypeFk")
                        .WithMany()
                        .HasForeignKey("AssetPartTypeId");

                    b.HasOne("Ems.Quotations.ItemType", "ItemTypeFk")
                        .WithMany()
                        .HasForeignKey("ItemTypeId");

                    b.HasOne("Ems.Assets.AssetPart", "ParentFk")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("Ems.Assets.Warehouse", "WarehouseFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Ems.Billing.CustomerInvoiceDetail", b =>
                {
                    ...
                    b.HasOne("Ems.Support.WorkOrderAction", "WorkOrderActionFk")
                        .WithMany()
                        .HasForeignKey("WorkOrderActionId");
                });
            ...
            modelBuilder.Entity("Ems.Support.MaintenanceStep", b =>
                {
                    ...
                    b.HasOne("Ems.Support.MaintenancePlan", "MaintenancePlanFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Ems.Support.WorkOrderUpdate", b =>
                {
                    b.HasOne("Ems.Assets.AssetPart", "AssetPartFk")
                        .WithMany()
