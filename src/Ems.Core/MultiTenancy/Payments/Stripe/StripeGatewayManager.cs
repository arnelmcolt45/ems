...
namespace Ems.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : EmsServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Ems";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + EmsConsts.Currency;
        }
