...
namespace Ems.Authorization.Users
{
    ...
    public class User : AbpUser<User>
    {
        ...
        public static User CreateTenantHostAdminUser(int tenantId, string emailAddress)
        {
            var user = new User
            {
                TenantId = tenantId,
        ...
        public static User CreateTenantAdminUser(int tenantId, string emailAddress, string adminUserName, string name, string surname)
        {
            var user = new User
            {
                TenantId = tenantId,
