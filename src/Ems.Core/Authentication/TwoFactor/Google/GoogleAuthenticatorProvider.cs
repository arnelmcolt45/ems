...
namespace Ems.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : EmsServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Ems", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
