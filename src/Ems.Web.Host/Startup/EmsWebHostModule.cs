...
namespace Ems.Web.Startup
{
    ...
    public class EmsWebHostModule : AbpModule
    {
        ...
        {
            Configuration.Modules.AbpWebCommon().MultiTenancy.DomainFormat = _appConfiguration["App:ServerRootAddress"] ?? "http://localhost:/";
            Configuration.Modules.AspNetZero().LicenseCode = _appConfiguration["AbpZeroLicenseCode"];
            IocManager.Register<IRolePermissionStore<Role>, RolePermissionStore>(DependencyLifeStyle.Transient);
        }
