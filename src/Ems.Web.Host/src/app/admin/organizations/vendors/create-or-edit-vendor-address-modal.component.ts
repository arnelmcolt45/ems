...
@Component({
    selector: 'createOrEditVendorAddressModal',
    templateUrl: './create-or-edit-vendor-address-modal.component.html'
})
export class CreateOrEditVendorAddressModalComponent extends AppComponentBase {
    ...
    show(addressId?: number, vendorId?: number): void {

        if (!addressId) {
            this.address = new CreateOrEditAddressDto();
            this.address.id = addressId;
            this.address.vendorId = vendorId;
            this.vendorName = '';
            this.assetOwnerName = '';
            this.vendorName = '';
