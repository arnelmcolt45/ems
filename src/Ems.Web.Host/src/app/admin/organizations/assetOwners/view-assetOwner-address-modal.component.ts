...
@Component({
    selector: 'viewAssetOwnerAddressModal',
    templateUrl: './view-assetOwner-address-modal.component.html'
})
export class ViewAssetOwnerAddressModalComponent extends AppComponentBase {
