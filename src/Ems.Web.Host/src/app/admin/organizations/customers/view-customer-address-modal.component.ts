...
@Component({
    selector: 'viewCustomerAddressModal',
    templateUrl: './view-customer-address-modal.component.html'
})
export class ViewCustomerAddressModalComponent extends AppComponentBase {
