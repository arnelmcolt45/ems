...
using Ems.Auditing.Exporting;
using Ems.Authorization;
using Ems.Authorization.Users;
using Ems.Dto;
using Ems.EntityHistory;
using EntityHistoryHelper = Ems.EntityHistory.EntityHistoryHelper;

namespace Ems.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : EmsAppServiceBase, IAuditLogAppService
    {
