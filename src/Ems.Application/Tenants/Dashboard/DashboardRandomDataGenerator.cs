...
namespace Ems.Tenants.Dashboard
{
    public static class DashboardRandomDataGenerator
    {
        ...
        public static List<RevenueForecastData> GenerateRevenueForecastData()
        {
            List<RevenueForecastData> data = null;

            data = new List<RevenueForecastData>
            {
                new RevenueForecastData(DateTime.Now.AddMonths(1).ToString("MMM yyyy"), Random.Next(22000, 27000)),
                new RevenueForecastData(DateTime.Now.AddMonths(2).ToString("MMM yyyy"), Random.Next(20000, 23000)),
                new RevenueForecastData(DateTime.Now.AddMonths(3).ToString("MMM yyyy"), Random.Next(20000, 25000)),
                new RevenueForecastData(DateTime.Now.AddMonths(4).ToString("MMM yyyy"), Random.Next(24000, 28000)),
                new RevenueForecastData(DateTime.Now.AddMonths(5).ToString("MMM yyyy"), Random.Next(20000, 24000)),
                new RevenueForecastData(DateTime.Now.AddMonths(6).ToString("MMM yyyy"), Random.Next(23000, 29000))
            };
