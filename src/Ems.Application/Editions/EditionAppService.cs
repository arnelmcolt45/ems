...
{
    public class EditionAppService : EmsAppServiceBase, IEditionAppService
    {
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_Editions)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_Editions_Create, AppPermissions.Pages_Administration_Editions_Edit)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_Editions_Create)]
        public async Task CreateEdition(CreateEditionDto input)
        {
            await CreateEditionAsync(input);
        }

        [AbpAuthorize(AppPermissions.Pages_Administration_Editions_Edit)]
        public async Task UpdateEdition(UpdateEditionDto input)
        {
            await UpdateEditionAsync(input);
        }

        [AbpAuthorize(AppPermissions.Pages_Administration_Editions_Delete)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_Editions_MoveTenantsToAnotherEdition)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Administration_Editions,AppPermissions.Pages_Administration_Tenants)]
