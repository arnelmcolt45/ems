...
{
    [AbpAuthorize(AppPermissions.Pages_Configuration_Languages)]
    public class LanguageAppService : EmsAppServiceBase, ILanguageAppService
    {
        ...
        [AbpAuthorize(AppPermissions.Pages_Configuration_Languages_Create, AppPermissions.Pages_Configuration_Languages_Edit)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Configuration_Languages_ChangeTexts)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Configuration_Languages_Create)]
        ...
        [AbpAuthorize(AppPermissions.Pages_Configuration_Languages_Edit)]
