...
using Ems.Configuration.Host.Dto;
...
namespace Ems.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : EmsAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<EmsDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(EmsConsts.ConnectionStringName).Value.ToString();
        }
