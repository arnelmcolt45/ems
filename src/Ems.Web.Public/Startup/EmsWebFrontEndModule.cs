...
namespace Ems.Web.Public.Startup
{
    [DependsOn(
        typeof(EmsWebCoreModule)
    )]
    public class EmsWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public EmsWebFrontEndModule(IHostingEnvironment env, EmsEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(EmsWebFrontEndModule).GetAssembly());
        }
    }
}
