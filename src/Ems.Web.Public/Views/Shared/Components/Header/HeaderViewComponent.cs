...
using Ems.Url;
using Ems.Web.Public.Startup;
using Ems.Web.Session;

namespace Ems.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : EmsViewComponent
    {
