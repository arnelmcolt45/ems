...
namespace Ems.Web.Authentication.JwtBearer
{
    public class EmsJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public EmsJwtSecurityTokenHandler()
        {
        ...
        {
            using (var securityStampHandler = IocManager.Instance.ResolveAsDisposable<IEmsJwtSecurityStampHandler>())
            {
