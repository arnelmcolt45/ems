...
{
    [AbpMvcAuthorize]
    public class TenantCustomizationController : EmsControllerBase
    {
        ...
        [HttpPost]
        [AbpMvcAuthorize(new string[]{AppPermissions.Pages_Administration_Tenant_Settings, AppPermissions.Pages_Main_AssetOwners_Profile})] 
