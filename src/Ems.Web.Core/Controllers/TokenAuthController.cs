...
using Ems.Web.Authentication.JwtBearer;
using Ems.Web.Authentication.TwoFactor;
using Ems.Web.Models.TokenAuth;
using Ems.Authorization.Impersonation;
...
using Ems.Web.Authentication.External;
...
namespace Ems.Web.Controllers
{
    ...
    public class TokenAuthController : EmsControllerBase
    {
        ...
        private readonly IEmsJwtSecurityStampHandler _securityStampHandler;
