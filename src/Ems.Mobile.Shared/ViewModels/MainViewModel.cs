...
using MvvmHelpers;
using Ems.Authorization.Users.Profile;
using Ems.Authorization.Users.Profile.Dto;
using Ems.Commands;
using Ems.Core.Threading;
using Ems.Models.NavigationMenu;
using Ems.Services.Navigation;
...
using Ems.UI.Assets;
using Ems.Views;
using DependencyResolver = Ems.Core.Dependency.DependencyResolver;
...
namespace Ems.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Ems";
